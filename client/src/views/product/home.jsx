...
import { Card, Button, Table, Icon, Select, Input, message } from "antd";
        ...
        render: (product) => (
          <LinkButton>
            <span
              ...
              onClick={this.showDetail.bind(this, product)}
            >
              详情
            </span>
            <span onClick={this.showUpdate.bind(this, product)}>修改</span>
          </LinkButton>
        ),
      },
    ];
  ...
  render() {
    ...
    const title = (
      <span>
        ...
        />
        <Button type="primary" onClick={this.getProductList.bind(this, 1)}>
          搜索
        </Button>
      </span>
    );
    const extra = (
      <Button type="primary" onClick={this.showUpdate.bind(this, {})}>
